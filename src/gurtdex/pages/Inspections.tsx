...
import { checklistSummary, itemNameMap, siteNameMap } from '../labels';
import {
  CHECKLIST,
  INSPECTION_LABELS,
  type CheckResult,
...
export function Inspections() {
  ...
  // Stammdaten (Standorte + PSA-Artikel) ändern sich durch Filter nicht — einmal laden.
  ...
  return (
    <>
      ...
      <p className="muted" style={{ marginTop: -6 }}>
        Append-only-Prüfprotokoll je PSA-Artikel — jeder Eintrag bleibt unveränderlich,
          ...
          fields={[
            {
              ...
              kind: 'select',
              required: true,
              hint: 'Die Prüfung wird dem einzelnen Artikel zugeordnet — der Standort ergibt sich daraus.',
              options: items
                .filter((e) => !e.retired)
                .map((e) => {
