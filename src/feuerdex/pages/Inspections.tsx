...
import { checklistSummary, extinguisherNameMap, siteNameMap } from '../labels';
import {
  CHECKLIST,
  INSPECTION_LABELS,
  type CheckResult,
...
export function Inspections() {
  ...
  // Stammdaten (Standorte + Löscher) ändern sich durch Filter nicht — einmal laden.
  ...
  return (
    <>
      ...
      <p className="muted" style={{ marginTop: -6 }}>
        Append-only-Prüfprotokoll je Feuerlöscher — jeder Eintrag bleibt unveränderlich,
          ...
          fields={[
            {
              ...
              kind: 'select',
              required: true,
              hint: 'Die Prüfung wird dem einzelnen Löscher zugeordnet — der Standort ergibt sich daraus.',
