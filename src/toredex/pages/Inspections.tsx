...
import { checklistSummary, gateNameMap, siteNameMap } from '../labels';
import {
  CHECKLIST,
  INSPECTION_LABELS,
  type CheckResult,
...
export function Inspections() {
  ...
  // Stammdaten (Objekte + Tore) ändern sich durch Filter nicht — einmal laden.
  ...
  return (
    <>
      ...
      <p className="muted" style={{ marginTop: -6 }}>
        Append-only-Prüfprotokoll je Tor — jeder Eintrag bleibt unveränderlich,
          ...
          fields={[
            {
              ...
              kind: 'select',
              required: true,
              hint: 'Die Prüfung wird dem einzelnen Tor zugeordnet — das Objekt ergibt sich daraus.',
              options: gates
                .filter((e) => !e.retired)
                .map((e) => {
